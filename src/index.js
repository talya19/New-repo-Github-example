...
axios.get(`${apiUrl}q=${cityInput.value}&appid=${apiKey}&units=metric`).then(showCelsius);
}else{
city.innerHTML=null;
...
axios.get(`${apiUrl}lat=${latitude}&lon=${longitude}&appid=${apiKey}&units=metric`).then(showCurrentTemperature);
}
